...
- **Atom_Signature_70Cols.csv** - Signature of the Atom cipher. A cell at location (i,j) represent the probabability of KSD_{j-1} to be 1 when fault is injected at location {i-1}. Assuming the csv file starts with row and column number 1.
